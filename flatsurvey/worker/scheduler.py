...
class Scheduler:
    ...
    def _render_command(self, source, goals, reporters):
        ...
        """
        from flatsurvey.worker.__main__ import create_object_graph
        import collections
        bindings = dict(collections.ChainMap({}, source, *goals, *reporters))
        objects = create_object_graph([source, *goals, *reporters])
